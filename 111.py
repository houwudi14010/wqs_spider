...
import pymysql
# 连接database
conn = pymysql.connect(host='localhost', user='root',password='123456',database='article',charset='utf8mb4')
# 得到一个可以执行SQL语句的光标对象
...
datas = (list(collectionpengyouquan.aggregate([{'$group': {'_id': '$auName'} }]).allowDiskUse(True)))
